...
import { Button } from "../UI/button"; // Update if your path differs
import { cn } from "../../lib/utils";  // Replace with your clsx or custom cn
    ...
    return (
      ...
      >
        <div
          ...
          onMouseEnter={() => api && plugins?.[0]?.stop?.()}
          onMouseLeave={() => api && plugins?.[0]?.reset?.()}
